import { comparatorReducer } from "@/app/(ui)/_shared/statistics/comparator/comparator.reducer";
import { ComparatorState, INITIAL_COMPARATOR_STATE } from "@/app/(ui)/_shared/statistics/comparator/comparator.types";
