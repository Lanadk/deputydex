...
import { ACTEURS_STATS } from "@/app/(ui)/(views)/(db)/statistics/_domains/acteurs/registry";
import { GROUPES_STATS } from "@/app/(ui)/(views)/(db)/statistics/_domains/groupes/registry";
import { VOTES_STATS } from "@/app/(ui)/(views)/(db)/statistics/_domains/votes/registry";
import { SCRUTINS_STATS } from "@/app/(ui)/(views)/(db)/statistics/_domains/scrutins/registry";
import { LEGISLATURES_STATS } from "@/app/(ui)/(views)/(db)/statistics/_domains/legislatures/registry";
