...
export const STATISTICS_CHARTS_REGISTRY: ChartConfig[] = [
    ...
    {
        id: 'activite-participation-evolution',
        title: 'Évolution de la participation',
        subtitle: 'Taux mensuel de participation du groupe RN — 17e législature',
        theme: 'activite',
        gatewayFn: async () => ({
            type: 'line',
            variant: 'parliament-group',
            ...
            data: [
                ...
                { label: 'Avr. 2025', value: 30.57 },
                { label: 'Mai 2025', value: 34.16 },
                { label: 'Juin 2025', value: 31.13 },
                { label: 'Juil. 2025', value: 26.69 },
                { label: 'Sept. 2025', value: 100.0 },
                { label: 'Oct. 2025', value: 61.32 },
                { label: 'Nov. 2025', value: 51.7 },
                { label: 'Déc. 2025', value: 32.29 },
                { label: 'Jan. 2026', value: 33.77 },
                { label: 'Fév. 2026', value: 24.94 },
            ],
        }),
    },
    {
