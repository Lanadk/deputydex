...
const HexRF = ({cx, cy, size}: { cx: number; cy: number; size: number }) => {
    ...
    return (
        <g transform={`translate(${tx},${ty}) scale(${s})`}>
            <path d="M110 18 L186 62 L186 158 L110 202 L34 158 L34 62 Z" fill="none" stroke="white" strokeOpacity=".35"
                  strokeWidth="6"/>
            <path d="M110 28 L178 66 L178 154 L110 192 L42 154 L42 66 Z" fill="none" stroke="white" strokeOpacity=".12"
                  strokeWidth="3"/>
            <path d="M110 34 L171 70 L171 150 L110 186 L49 150 L49 70 Z" fill="none" stroke="white" strokeOpacity=".15"
                  strokeWidth="2"/>
            <path d="M110 44 L164 76 L164 144 L110 176 L56 144 L56 76 Z" fill="none" stroke="white" strokeOpacity=".08"
                  strokeWidth="1"/>
            <text
                x="110"
                y="132"
